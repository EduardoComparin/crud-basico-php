...
if (!isset($_GET['edit'])) {
    ...
    $tipo = "Edit";
    $categoria = json_decode(base64_decode($_GET['edit']), true);
}
...
<!-- Main Content -->
<main class="content">
    <h1 class="title new-item"><?php echo  $tipo; ?> Category</h1>

    <form method="post" name="categoria" action="..\controller\categoria.php">
        <div class="input-field">
            <input value="<?php echo $categoria['id'] ?>" name="id" type="hidden" />
        </div>

        <div class="input-field">
            <label for="category-name" class="label">Category Name</label>
            <input value="<?php echo $categoria['descricao'] ?>" name="descricao" type="text" id="category-name" class="input-text" maxlength="250" onkeyup="setString(this)" />

        </div>
        <div class="input-field">
            <label for="category-code" class="label">Category Code</label>
            <input value="<?php echo $categoria['codigo'] ?>" name="codigo" type="text" id="category-code" class="input-text" maxlength="13" onkeyup="setInteiro(this)" />
