      ...
      <?php while ($linha = $todasCategorias->fetch_assoc()) { ?>
        <tr class="data-row">
          <td class="data-grid-td">
            <span class="data-grid-cell-content"><?php echo $linha['descricao'] ?></span>
          </td>
          ...
          <td class="data-grid-td">
            <div class="actions">
              <a href="controller\categoria.php?edit=<?php echo $linha['id'] ?>" class="action edit">Edit</a>
              <a href="controller\categoria.php?delete=<?php echo $linha['id'] ?>" class="action delete">Delete</a>
            </div>
          </td>
        </tr>
      <?php } ?>
