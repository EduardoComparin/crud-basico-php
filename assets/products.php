...
$todosProduto = $produtoDb->buscaTodosProdutos();
?>
<!doctype html>
<html ⚡>
...
<header>
    <div class="go-menu">
        ...
        <a href="dashboard.php" class="link-logo"><img src="images/go-logo.png" alt="Welcome" width="69"
                height="430" /></a>
    </div>
    <div class="right-box">
...
<body>
    ...
    <main class="content">
        ...
        <table class="data-grid" style="font-size: 12px!important;">
            <tr class="data-row">
            ...
            <?php while ($linha = $todosProduto->fetch_assoc()) { ?>
            <tr class="data-row">
                ...
                <td class="data-grid-td">
                    <span class="data-grid-cell-content"><?php echo $linha['sku']?></span>
                </td>

                <td class="data-grid-td">
                    <span class="data-grid-cell-content"><?php echo $linha['preco']?></span>
                </td>
                ...
                <td class="data-grid-td">
                    <span class="data-grid-cell-content"><?php echo $linha['categoria']?></span>
                </td>

                <td class="data-grid-td">
                    <div class="actions">
                        <a href="controller\produto.php?edit=<?php echo $linha['id'] ?>" class="action edit">Edit</a>
                        <a href="controller\produto.php?delete=<?php echo $linha['id'] ?>" class="action delete">Delete</a>
                    </div>
                </td>
            </tr>
            <?php } ?>
